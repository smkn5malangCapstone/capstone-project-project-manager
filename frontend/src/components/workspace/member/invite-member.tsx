  ...
  return (
    <div className="flex flex-col pt-0.5 px-0 ">
      <h5 className="text-lg  leading-[30px] font-semibold mb-1">
        Undang anggota untuk bergabung dengan Anda
      </h5>
      <p className="text-sm text-muted-foreground leading-tight">
        Siapapun dengan tautan undangan dapat bergabung dengan Ruang Kerja gratis ini. Anda juga dapat menonaktifkan dan membuat tautan undangan baru untuk Ruang Kerja ini kapan saja.
      </p>
